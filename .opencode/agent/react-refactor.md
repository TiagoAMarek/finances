...
description: >-
  Use this agent when you need to refactor React components in a Next.js application to improve code quality, performance, security, or maintainability.
  Examples include: when components have grown too large and need to be broken down, when performance optimizations are needed, when security vulnerabilities need to be addressed,
  when code needs to follow better patterns, or when components need to be made more reusable and testable.

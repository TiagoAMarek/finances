      ...
      case "last3":
        const last3Month =
          now.getMonth() - 2 < 0
            ...
            : now.getMonth() - 2;
        const last3Year =
          now.getMonth() - 2 < 0 ? now.getFullYear() - 1 : now.getFullYear();
      ...
      case "last6":
        const last6Month =
          now.getMonth() - 5 < 0
            ...
            : now.getMonth() - 5;
        const last6Year =
          now.getMonth() - 5 < 0 ? now.getFullYear() - 1 : now.getFullYear();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  onAccountChange(value === "all" ? null : parseInt(value))
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  onCreditCardChange(value === "all" ? null : parseInt(value))
                }
              >
                <SelectTrigger>

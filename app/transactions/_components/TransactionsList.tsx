...
import { Receipt, TrendingUpIcon, TrendingDownIcon, BarChart3, CalendarIcon } from "lucide-react";
    ...
    <Card className="border-dashed">
      <CardContent className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="text-xl font-semibold mb-2">
          {isFiltered ? 'Nenhum lançamento encontrado com os filtros aplicados' : 'Nenhum lançamento encontrado'}
        </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="font-medium text-muted-foreground">Taxa de Gastos</span>
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/30">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-foreground">Valor Médio</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-medium text-foreground">Principais Categorias</h3>
              </div>
          ...
          {monthlyEntries.length > 1 && (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-medium text-foreground">Distribuição Mensal</h3>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {monthlyEntries.map(([month, stats]) => (
                  <div key={month} className="p-3 rounded-lg border border-border bg-card">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">Seus Lançamentos</h2>
          </div>
          <div className="flex items-center gap-2">
            <Badge variant="secondary" className="text-xs">

...
import { TrendingDown, Target, PiggyBank, Award, TrendingUp, AlertCircle, Calendar } from "lucide-react";
  ...
  const monthlyCards = [
    {
      ...
      bgColor: savingsRate >= 20 ? "bg-green-500/10" : savingsRate >= 10 ? "bg-yellow-500/10" : "bg-red-500/10"
    },
    {
      title: "Maior Receita",
    ...
    },
    {
      ...
      bgColor: monthlyIncomes > 0 && (monthlyExpenses / monthlyIncomes) <= 0.8 ? "bg-green-500/10" : "bg-yellow-500/10"
    }
  ];

 ...
 */
export const FormModalHeader = memo<FormModalHeaderProps>(
  function FormModalHeader({
    ...
    const iconClasses = useMemo(() => `h-6 w-6 ${iconColor}`, [iconColor]);
    ...
    return (
      <DialogHeader className="text-center space-y-3 pb-4">
        <div className={iconContainerClasses}>{iconComponent}</div>

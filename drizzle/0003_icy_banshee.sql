...
CREATE INDEX IF NOT EXISTS "credit_card_statements_file_hash_idx" ON "credit_card_statements" ("file_hash");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "statement_line_items_duplicate_idx" ON "statement_line_items" ("is_duplicate");--> statement-breakpoint
